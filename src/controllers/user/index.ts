...
import EditUserController, { EditUserBodySchema, EditUserParamsSchema } from './EditUser.controller';
...
UsersRouter.patch('/:userId', AdminGuard, validator.params(EditUserParamsSchema), validator.body(EditUserBodySchema), EditUserController);
